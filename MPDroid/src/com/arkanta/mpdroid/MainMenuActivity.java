...
import com.arkanta.mpdroid.CoverAsyncHelper.CoverDownloadListener;
				...
				switch(v.getId()) {
					case R.id.next:
						...
						if(((MPDApplication) getApplication()).isStreamingMode()) {
							...
							i.setAction("com.arkanta.mpdroid.RESET_STREAMING");
							startService(i);
						}
						break;
					case R.id.prev:
			...
			try {
				switch(v.getId()) {
					case R.id.playpause:
						...
						if(((MPDApplication) getApplication()).isStreamingMode()) {
							i = new Intent(app, StreamingService.class);
							i.setAction("com.arkanta.mpdroid.STOP_STREAMING");
							startService(i);
						}
						break;
					default:
