...
class ListViewPlusView extends ViewGroup {
	...
	public ListViewPlusView(Context context, AttributeSet attrs, int defStyle) {
		...
		/*
		 * mButton.setOnClickListener(mButtonListener); mButton.setImageResource(android.R.drawable.ic_input_add);
		 * mButton.setBackgroundResource(android.R.drawable.btn_default_small); DisplayMetrics dm =
		 * context.getResources().getDisplayMetrics(); mButtonWidth = (int) (35*((float)dm.densityDpi/160));
		 */
