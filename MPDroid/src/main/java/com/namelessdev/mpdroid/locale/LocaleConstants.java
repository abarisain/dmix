...
public final class LocaleConstants
{
    ...
    /**
     * {@code LocaleConstants} action {@code String} broadcast by Locale to create or edit a plug-in setting. When
     * Locale broadcasts this {@code LocaleConstants}, it will be sent directly to the package and class of the
     * plug-in's {@code Activity}. The {@code LocaleConstants} may contain a {@link #EXTRA_BUNDLE} that was previously
     * set by the {@code Activity} result of {@link #ACTION_EDIT_SETTING}.
     * <p>
     * There SHOULD be only one {@code Activity} per APK that implements this {@code LocaleConstants}. If a single APK
     * wishes to export multiple plug-ins, it MAY implement multiple Activity instances that implement this
     * {@code LocaleConstants}, however there must only be a single {@link #ACTION_FIRE_SETTING} receiver. In this
    ...
    /**
     * {@code LocaleConstants} action {@code String} broadcast by Locale to fire a plug-in setting. When Locale
     * broadcasts this {@code LocaleConstants}, it will be sent directly to the package and class of the plug-in's
     * {@code BroadcastReceiver}. The {@code LocaleConstants} will contain a {@link #EXTRA_BUNDLE} that was previously
     * set by the {@code Activity} result of {@link #ACTION_EDIT_SETTING}.
     * <p>
     * There MUST be only one {@code BroadcastReceiver} per APK that implements this {@code LocaleConstants}.
     * 
     * @see LocaleConstants#EXTRA_BUNDLE
     */
    ...
    /**
     * {@code LocaleConstants} action {@code String} broadcast by Locale to create or edit a plug-in condition. When
     * Locale broadcasts this {@code LocaleConstants}, it will be sent directly to the package and class of the
     * plug-in's {@code Activity}. The {@code LocaleConstants} may contain a store-and-forward {@link #EXTRA_BUNDLE}
     * that was previously set by the {@code Activity} result of {@link #ACTION_EDIT_CONDITION}.
     * <p>
     * There SHOULD be only one {@code Activity} per APK that implements this {@code LocaleConstants}. If a single APK
     * wishes to export multiple plug-ins, it MAY implement multiple Activity instances that implement this
     * {@code LocaleConstants}, however there must only be a single {@link #ACTION_QUERY_CONDITION} receiver. In this
     * scenario, it is the responsibility of the Activities to store enough data in {@link #EXTRA_BUNDLE} to
    ...
    /**
     * Ordered {@code LocaleConstants} action {@code String} broadcast by Locale to query a plug-in condition. When
     * Locale broadcasts this {@code LocaleConstants}, it will be sent directly to the package and class of the
     * plug-in's {@code BroadcastReceiver}. The {@code LocaleConstants} will contain a {@link #EXTRA_BUNDLE} that was
    ...
    /**
     * {@code LocaleConstants} action {@code String} to notify Locale that a plug-in condition is requesting that
     ...
     * this {@code LocaleConstants} is broadcast. If Locale does not respond to the plug-in condition after a
     * {@link #ACTION_REQUEST_QUERY} LocaleConstants is sent, the plug-in SHOULD shut itself down and stop requesting
     ...
     * <p>
     * The extra {@link #EXTRA_ACTIVITY} MUST be included, otherwise Locale will ignore this {@code LocaleConstants}.
     * <p>
     * Plug-in conditions SHOULD NOT use this unless there is some sort of asynchronous event that has
     * occurred, such as a broadcast {@code LocaleConstants} being received by the plug-in. Plug-ins SHOULD NOT
