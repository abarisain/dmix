...
public final class LocaleConstants {
     ...
     * has occurred, such as a broadcast {@code LocaleConstants} being received by the plug-in.
     * Plug-ins SHOULD NOT periodically request a requery as a way of implementing polling
     * behavior.
     *
     ...
     * 500 kilobytes (base-10), while Locale further limits plug-in Bundles to about 100 kilobytes
     * (base-10). Although the maximum size is about 100 kilobytes, plug-ins SHOULD keep Bundles
     * much smaller for performance and memory usage reasons.
     */
     ...
     * process a requery. A {@code BroadcastReceiver} must return within 10 seconds, otherwise it
