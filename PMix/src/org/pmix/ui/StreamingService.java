...
public class StreamingService extends Service
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		if (intent.getAction().equals("org.pmix.START_STREAMING")) {
			//streaming_enabled = true;
			resumeStreaming();
		} else if (intent.getAction().equals("org.pmix.STOP_STREAMING")) {
			stopStreaming();
		} else if (intent.getAction().equals("org.pmix.RESET_STREAMING")) {
			stopStreaming();
			resumeStreaming();
		}
