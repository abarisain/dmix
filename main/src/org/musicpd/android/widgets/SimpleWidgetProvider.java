...
public class SimpleWidgetProvider extends AppWidgetProvider {
    static final String TAG = "MupeaceSimpleWidgetProvider";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        // Initialise given widgets to default state, where we launch Mupeace on default click and hide actions if service not running.
