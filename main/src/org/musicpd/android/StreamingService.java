...
public class StreamingService extends Service implements StatusChangeListener, OnPreparedListener, OnCompletionListener,
	...
	static final String TAG = "MupeaceStreamingService";
	...
	public static final String CMD_REMOTE = "org.musicpd.android.REMOTE_COMMAND";
		...
		if (needStoppedNotification) {
			...
			Notification status = new NotificationCompat.Builder(this)
				...
				.setContentIntent(PendingIntent.getActivity(this, 0,
						new Intent("org.musicpd.android.PLAYBACK_VIEWER").addFlags(Intent.FLAG_ACTIVITY_NEW_TASK), 0))
				.getNotification();
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if (intent.getAction().equals("org.musicpd.android.START_STREAMING")) {
			// streaming_enabled = true;
			resumeStreaming();
		} else if (intent.getAction().equals("org.musicpd.android.STOP_STREAMING")) {
			stopStreaming();
		} else if (intent.getAction().equals("org.musicpd.android.RESET_STREAMING")) {
			stopStreaming();
			resumeStreaming();
		} else if (intent.getAction().equals("org.musicpd.android.DIE")) {
			die();
		...
		// Toast.makeText(this, "onStartCommand  : "+(intent.getAction() == "org.musicpd.android.START_STREAMING"),
