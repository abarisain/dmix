...
public class MPDPlaylist {
	...
	/**
	 * Retrieves music at position idx in playlist. Operates on local copy of playlist, may not reflect server's current playlist. You may
	 * call refresh() before calling get().
	 * 
	 * @param idx
	 *           position.
