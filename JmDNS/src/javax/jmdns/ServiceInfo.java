...
public abstract class ServiceInfo implements Cloneable {
     ...
     * 
     * @param qualifiedNameMap dictionary of values to build the fully qualified
     *            service name. Mandatory keys are Application and Instance. The
     *            Domain default is local, the Protocol default is tcp and the
     *            subtype default is none.
     ...
     */
    public static ServiceInfo create(final Map<Fields, String> qualifiedNameMap, final int port,
     ...
     * @return new service info
     */
    public static ServiceInfo create(final String type, final String name, final int port,
            final int weight, final int priority, final boolean persistent, final byte[] text) {
     ...
     */
    public static ServiceInfo create(final String type, final String name, final int port,
            final int weight, final int priority, final boolean persistent, final String text) {
        return new ServiceInfoImpl(type, name, "", port, weight, priority, persistent, text);
    }
     ...
     */
    public static ServiceInfo create(final String type, final String name, final int port,
            final int weight, final int priority, final byte[] text) {
     ...
     */
    public static ServiceInfo create(final String type, final String name, final int port,
            final int weight, final int priority, final Map<String, ?> props) {
     ...
     */
    public static ServiceInfo create(final String type, final String name, final int port,
            final int weight, final int priority, final String text) {
        return new ServiceInfoImpl(type, name, "", port, weight, priority, false, text);
    }
     ...
     * @param name unqualified service instance name, such as
     *            <code>foobar</code>
     * @param subtype service subtype see draft-cheshire-dnsext-dns-sd-06.txt
     ...
     * @return new service info
     */
    public static ServiceInfo create(final String type, final String name, final String subtype,
            final int port, final int weight, final int priority, final boolean persistent,
            final byte[] text) {
     ...
     */
    public static ServiceInfo create(final String type, final String name, final String subtype,
            final int port, final int weight, final int priority, final byte[] text) {
     ...
     */
    public static ServiceInfo create(final String type, final String name, final String subtype,
            final int port, final int weight, final int priority, final Map<String, ?> props) {
     ...
     */
    public static ServiceInfo create(final String type, final String name, final String subtype,
            final int port, final int weight, final int priority, final String text) {
        return new ServiceInfoImpl(type, name, subtype, port, weight, priority, false, text);
    }
     ...
     * @exception IllegalStateException if attempting to set the text for a non
     *                persistent service info.
     */
